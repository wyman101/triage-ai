...
async function main() {
    ...
    if (ctxTruncatedModels.length > 0) {
        ...
        progress.updateItem('Context truncation', 'skipped', `input context was truncated — analysis may be incomplete`);
    }
    ...
    if (outTruncatedModels.length > 0) {
        ...
        progress.updateItem('Output truncation', 'skipped', `output was truncated for ${names} — some findings may be missing`);
    }
